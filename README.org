...
Docker repository front end: https://hub.docker.com/repository/docker/benssoon/fi-lo-games/general

Docker repository back end: forthcoming...
...
*** Voor de frontend
1. Pull de Docker image voor de frontend applicatie.
   - ~docker pull benssoon/fi-lo-games~
2. Draai de applicatie met Docker.
   - ~docker run -p 3000:3000 benssoon/fi-lo-games~
*** Voor de backend
