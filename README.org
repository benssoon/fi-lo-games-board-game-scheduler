...
Docker repository front end: https://hub.docker.com/repository/docker/benssoon/fi-lo-games-frontend/general

Docker repository back end: https://hub.docker.com/repository/docker/benssoon/fi-lo-games-backend/general

API Documentatie: https://app.swaggerhub.com/apis-docs/benz-2f9/Fi-Lo-Games/1.0.0?view=uiDocs

* TOC
- [[*Inleiding][Inleiding]]
- [[*Benodigdheden (met minimale versienummers)][Benodigdheden (met minimale versienummers)]]
  + [[*Bij gebruik van Docker][Bij gebruik van Docker]]
  + [[*Bij gebruik zonder Docker][Bij gebruik zonder Docker]]
- [[*Projectstructuur][Projectstructuur]]
- [[*Installatie][Installatie]]
  + [[*Met Docker][Met Docker]]
  + [[*Zonder Docker][Zonder Docker]]
- [[*Overige Informatie][Overige Informatie]]
  + [[Tests][Tests]]
  + [[Standaardgebruikers][Standaardgebruikers]]
* Inleiding
...
** Bij gebruik van Docker
- Docker
  + Minimale versie: 29.3.0
** Bij gebruik zonder Docker
*** Voor de frontend
- Node.js
...
1. Installeer Docker.
   ...
   - Onder het knopje "Download Docker Desktop", selecteer jouw OS en volg de aangegeven instructies.
2. Download [[docker-compose.yml][docker-compose.yml]] van deze repository.
3. In de terminal, vanuit de map waar je docker-compose.yml heb geplaatst, voer de commando ~docker compose up~ uit.
4. Open een browser en ga naar [[http://localhost:3000][localhost:3000]].
** Zonder Docker
